...
function s.drcfilter(c,tp,lg)
    return c:IsSetCard(0x7bc) and c:IsType(TYPE_XYZ) and c:IsPreviousLocation(LOCATION_EXTRA)
...
function s.spfilter(c,e,tp,attr)
    return c:IsSetCard(0x7bc) and c:GetOriginalAttribute() & attr ~=0
