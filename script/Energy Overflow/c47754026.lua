--Energy Overflow Yggdrasil the World Tree
--Script by Coroln
local s,id=GetID()
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x454F) and not c:IsType(TYPE_SYNCHRO) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
