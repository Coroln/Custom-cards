...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
    --spsummon 1 Legendary monster from GY
...
function s.filter(c,e,tp)
	return c:IsRace(RACE_LEGENDARY) and not c:IsCode(id) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
