...
function Trick.AddProcedure(c,desc,con,mons,traps)
	...
	e:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE+EFFECT_FLAG_IGNORE_IMMUNE)
	...
	ex:SetOperation(function(e) Duel.DisableShuffleCheck() Duel.Sendto(c,LOCATION_EXTRA,REASON_RULE,POS_FACEDOWN) end)
	c:RegisterEffect(ex)
	...
	e2:SetOperation(function(e) c:Type(c:Type()|TYPE_FUSION) Duel.DisableShuffleCheck() Duel.Sendto(c,LOCATION_EXTRA,REASON_RULE,POS_FACEDOWN) end)
	c:RegisterEffect(e2)
