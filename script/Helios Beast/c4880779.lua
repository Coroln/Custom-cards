--Helios Beast - Aretos the Tin Talon
--Script by Coroln
...
function s.filter(c,e,tp)
	return c:IsTrueHelios() and c:IsMonster() and c:IsLevelBelow(4) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.sretop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) then
		Duel.Destroy(tc,1,REASON_EFFECT)
	end
end
