...
function s.hspconfilter(c)
  return c:IsFaceup() and c:IsSetCard(0x2998) and c:GetRank()==4 and c:IsType(TYPE_XYZ)
end
...
function s.xyzfilter(c,e,tp)
  return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x2998) and c:GetRank()==4 and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_XYZ,tp,false,false)
end
