...
function s.xyzfilter1(c,e,tp)
  return c:IsFaceup() and c:IsSetCard(0x998) and c:IsLevelAbove(3) and Duel.GetLocationCountFromEx(tp,tp,c)>0 
...
function s.rtdfilter(c)
  return c:IsSetCard(0x2998) and c:IsType(TYPE_MONSTER) and c:IsAbleToExtra()
end
