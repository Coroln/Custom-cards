...
function s.spfilter1(c,e,tp)
  return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x998) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.spfilter2(c,e,tp)
  return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x1998) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
