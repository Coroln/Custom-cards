...
function s.thfilter1(c,tp)
  return c:IsFaceup() and c:IsSetCard(0x998) and Duel.IsExistingMatchingCard(s.thfilter2,tp,LOCATION_DECK,0,1,nil,c:GetOriginalLevel())
end
...
function s.spfilter(c,e,tp)
  return c:IsSetCard(0x998) and c:IsFaceup() and c:IsType(TYPE_PENDULUM) 
