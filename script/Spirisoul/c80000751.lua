...
function s.initial_effect(c)
	...
	--Activate and (you can) Special Summon from the GY
...
function s.filter(c,e,tp)
	return c:IsLocation(LOCATION_GRAVE) and c:GetPreviousControler()==tp and c:IsReason(REASON_BATTLE) and c:IsType(TYPE_SPIRIT) 
        and c:IsLevelBelow(4) and c:IsCanBeSpecialSummoned(e,0,tp,true,true)
 end
