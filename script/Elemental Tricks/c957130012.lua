...
function s.atlimit(e,c)
	return c~=e:GetHandler() and c:IsFaceup() and c:IsAttribute(ATTRIBUTE_WIND) and not c:IsCode(id)
end
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsAttribute(ATTRIBUTE_WIND) and tc:IsLevelBelow(4) and tc:IsRelateToEffect(e) then
