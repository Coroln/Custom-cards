...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0xC55) and c:IsAttribute(ATTRIBUTE_WATER) and not c:IsCode(id) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.thfilter(c)
	return c:IsSetCard(0xC55) and not c:IsAttribute(ATTRIBUTE_WATER) and c:IsAbleToHand()
end
