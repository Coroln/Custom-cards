...
function s.initial_effect(c)
	...
	e2:SetValue(1)
	c:RegisterEffect(e2)
    --Special Summon Level 4 or lower Illusory monster
	...
	e3:SetTarget(s.sptge3)
	e3:SetOperation(s.spope3)
	c:RegisterEffect(e3)
...
function s.spope3(e,tp,eg,ep,ev,re,r,rp)
