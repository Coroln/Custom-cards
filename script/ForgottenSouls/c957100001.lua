...
s.listed_names={04920010,957100000,id}

function s.ATKfilter(c)
	return c:IsFaceup() and (Card.IsCode(c,04920010)or Card.IsCode(c,957100000) or Card.IsCode(c,id))
end

function s.atkval(e,c)
	return Duel.GetMatchingGroupCount(s.ATKfilter,c:GetControler(),LOCATION_REMOVED,0,nil)*900
end
...
function s.costfilter(c,tp)
	return c:IsCode(04920010,957100000,id) and c:IsAbleToRemoveAsCost() and aux.SpElimFilter(c,true) 
