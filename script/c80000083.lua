...
function s.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	Fusion.AddProcMix(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x3B),71625222)
    --Activation Limit
	...
	c:RegisterEffect(e1)
    --Special Summon 2 non-Fusion "Red-Eyes" monsters with different names from GY
...
function s.actcon(e)
	...
	return a and a:IsControler(e:GetHandlerPlayer()) and a:IsSetCard(0x3B)
end
--
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x3B) and not c:IsType(TYPE_FUSION)
