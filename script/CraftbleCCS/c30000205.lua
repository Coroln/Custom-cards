...
function s.thcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToGraveAsCost() and e:GetHandler():GetCounter(0x1c)>=1 end
...
function s.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetTargetParam(e:GetHandler():GetCounter(0x1c))
...
function s.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local ag=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(s.filter2),tp,LOCATION_DECK+LOCATION_GRAVE,0,1,d,nil,tc:GetCode())
