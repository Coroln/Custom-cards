...
function s.arcanareg(c,coin)
	...
	if coin==COIN_HEADS then c:EnableCounterPermit(COUNTER_SPELL) end
	local e1=Effect.CreateEffect(c)
...
function s.efilter(e,te)
	return te:IsActiveType(TYPE_SPELL) and te:GetOwnerPlayer()~=e:GetHandlerPlayer() and Arcana.GetCoinResult(e:GetHandler())==COIN_HEADS
end
