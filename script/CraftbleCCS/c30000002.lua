...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	local token1=Duel.CreateToken(tp,87774234)
	local token2=Duel.CreateToken(tp,87774234)
	local token3=Duel.CreateToken(tp,87774234)
	local token4=Duel.CreateToken(tp,87774234)
	local token5=Duel.CreateToken(tp,87774234)
