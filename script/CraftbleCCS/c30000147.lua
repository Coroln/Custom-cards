...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	local token1=Duel.CreateToken(tp,55144522)
	local token2=Duel.CreateToken(tp,83764719)
	local token3=Duel.CreateToken(tp,30000007)
	local token4=Duel.CreateToken(tp,30000006)
	local token5=Duel.CreateToken(tp,id)
