...
function s.initial_effect(c)
	...
	e3:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0xF008))
	e3:SetValue(500)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
...
function s.cfilter(c,tp)
	return c:IsSetCard(0xF008) and c:IsPreviousControler(tp) and c:IsPreviousLocation(LOCATION_HAND)
end
