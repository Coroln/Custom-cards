...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.adfilter,tp,LOCATION_HAND,0,1,nil) end
	Duel.DiscardHand(tp,s.adfilter,1,1,REASON_COST+REASON_DISCARD)
end
